...
class Contact(models.Model):
    interest_in = models.ManyToManyField(
        InterestIn,
        db_column="InterestInID",
        related_name="interest_in_contact",
        default=None,
    )
    specialty = models.ForeignKey(
        Specialty,
        db_column="SpecialtyID",
        related_name="specialty_id",
        on_delete=models.CASCADE,
    )
    i_would_like_to = models.ForeignKey(
        IWouldLikeTo,
        db_column="IWouldLikeToID",
        related_name="i_would_like_to_contact",
        on_delete=models.CASCADE,
    )
    notes = models.TextField(db_column="Notes", blank=True, null=True, default="")
    name = models.CharField(
        db_column="Name", blank=True, null=True, default="", max_length=255
    )
    surname = models.CharField(
        db_column="SurName", blank=True, null=True, default="", max_length=255
    )
    name_of_hospital = models.CharField(
        db_column="NameOfHospital", blank=True, null=True, default="", max_length=255
    )
