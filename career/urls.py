...
from career.views import JobCityListingView, CandidateGroupByView, JobLocationView, DeletedCandidateView, DeletedJobView, JobListingView, CandidateDetailView, JobPostingView, DeleteJobView, AdminCandidateView, JobViewSet, AdminCandidateForJobView, CandidateViewSet, EmailDataView
...
urlpatterns = [
    ...
    path('deleted-candidate/<int:pk>', DeletedCandidateView.as_view(), name = 'deleted-candidate'), 

    path('candidate/view/', CandidateDetailView.as_view(), name='candidate-view'),
    path('candidate/view/<int:pk>', CandidateDetailView.as_view(), name='candidate-view'),
    ...
    path('candidate/detail/<int:pk>', AdminCandidateView.as_view(), name='candidate-detail'),

    path('candidate/applied/job/', AdminCandidateForJobView.as_view(), name= 'candidate-applied-for-job'),
