...
class CandidateDetail(models.Model):
	job = models.ForeignKey(JobPosting,  db_column='JobId', related_name= "candidate_job", on_delete = models.CASCADE)	
	...
	# phone_number = models.CharField(max_length = 255, db_column = "PhoneNumber")
	# city = models.CharField(db_column='City',max_length= 255)
	# title = models.CharField(max_length = 255, db_column = "Title")
	# last_company = models.CharField(max_length = 255, db_column = "LastCompany")
	...
	# 	(2, 'Not From US'),
	# )
	# us_check = models.IntegerField(choices=US_CHECK, db_column = 'USOrNotUS')
	resume= models.FileField(upload_to ='uploads/', db_column = "Resume", null = True, blank = True)
	new_file= models.FileField(upload_to ='uploads/', db_column = "NewFile", null = True, blank = True)
	deleted = models.BooleanField(default=False)
