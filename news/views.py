        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    description="News is created successfuly",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return self.send_response(
                    ...
                    code=f"201",
                    status_code=status.HTTP_201_CREATED,
                    description="News is updated successfuly",
                )
            return self.send_response(
                code=f"422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
            ...
            return self.send_response(
                code="422",
                status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
                description="No News matches the given query.",
            )
        except News.DoesNotExist:
            return self.send_response(
                code=f"422",
        ...
        try:
            if pk is not None:
                ...
                if news.status == False:
                    return self.send_response(
                        description="News disabled successfuly",
                        success=True,
                        status_code=status.HTTP_200_OK,
                        code="200",
                    )
                return self.send_response(
                    description="News enabled successfuly",
                    success=True,
                    status_code=status.HTTP_200_OK,
                    code="200",
                )
    ...
    def get(self, request, pk=None):
        try:
            if pk is not None:
                ...
                print(news.status)
                return self.send_response(
                    description="News Deleted successfuly",
                    success=True,
                    status_code=status.HTTP_200_OK,
                    code="200",
                )
