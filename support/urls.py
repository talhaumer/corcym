...
from support.views import DonationGroupByView, SupportGroupByView, EmailCityView, EmailCountryView, EmailSendingView, DonationEmailSendingView, WhoIAmView, HowCanIHelpYouView, EmailViewSet, DonationViewSet
...
urlpatterns = [
    ...
    path('donation/email/sending', DonationEmailSendingView.as_view(), name='donation-email-sending'),
    path('donation/email/sending/<int:pk>', DonationEmailSendingView.as_view(), name='donation-email-sending'),
    ...
    path('how-can-i-help-you/<int:pk>', HowCanIHelpYouView.as_view(), name='how-can-i-help-you'),

    path('email-support-groupby', SupportGroupByView.as_view(), name = 'email-support-groupby'),
