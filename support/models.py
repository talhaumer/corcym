...
# 	cities_name = models.CharField(max_length = 50)
# 	cities_code = models.SlugField(max_length=255, unique=True)

# 	class Meta:
# 		verbose_name = "City"
# 		verbose_name_plural = "Cities"
# 		ordering = ('cities_name',)
...
# 		try:
# 			if not self.pk:
# 				self.cities_code = slugify(self.cities_name)
# 			super().save()
# 		except Exception:
# 			raise
...
class EmailSupport(models.Model):
	...
	i_am = models.ForeignKey(IAm,  db_column='IAmId', related_name= "i_am_support", on_delete = models.CASCADE)
	...
	phone_number = models.CharField(db_column='PhoneNumber',  max_length= 255, null = True, blank= True)
	how_can_we_help = models.ForeignKey(HowCanWeHelpYou,  db_column='HowCanWeHelpYouId', related_name= "email_support_how_can_we_help", on_delete = models.CASCADE)
...
# 	# countries_code = models.SlugField(max_length=255, unique=True)

# 	# class Meta:
# 	# 	verbose_name = "Country"
# 	# 	verbose_name_plural = "Countries"
# 	# 	ordering = ('countries_name',)
...
# 	# 	try:
# 	# 		if not self.pk:
# 	# 			self.countries_code = slugify(self.countries_name)
# 	# 		super().save()
# 	# 	except Exception:
# 	# 		raise
...
class Donation(models.Model):
	country = models.CharField(db_column='Country', max_length=255)	
	applicant_organization = models.CharField(db_column= 'ApplicantOrganizationName', max_length = 255)
	name = models.CharField(db_column = 'NameInLocalLanguage', max_length = 255, null = True, blank = True)
	email = models.EmailField(unique=False, db_column="Email", help_text="Email Field")
	applicant_organization_address = models.TextField(db_column = 'ApplicantOrganizationAddress')
	organization_type = models.CharField(db_column='OrganizationType', max_length = 255)
	organization_tax_id = models.CharField(db_column=  'OrganizationTaxId', max_length= 255, null = True, blank = True)
	website = models.TextField(db_column='Website', null = True, blank = True)
	w9_form = models.FileField(upload_to ='uploads/', db_column = "W-9Form", null = True, blank = True)
	TYPE_OF_REQUEST = (
		(1, 'Educational Grant'),
		(2, 'Research Grant'),
	...
	type_of_request = models.IntegerField(choices=TYPE_OF_REQUEST, db_column = 'ResearchGrant',  null = True, blank = True)
