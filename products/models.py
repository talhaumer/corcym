...
class Products(models.Model):
	...
	PRODUCT_TYPE = (
		(1, "Mechanical"),
		(2, "Biological"))
	product_type = models.IntegerField(choices=PRODUCT_TYPE, null = True, blank = True,  default= None, db_column = "ProductType")
	video_link = models.CharField(max_length = 255, default = "", db_column = "VideoLink")
	doctor_image = models.ImageField(upload_to = 'uploads/', db_column = "DoctorImage", null = True, blank  = True)
